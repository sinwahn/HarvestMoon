...
// --- BinaryIO.js ---
	 ...
	 */
	export class BinaryReaderPrimitive extends BinaryContainer {
		/**
	 ...
	 */
	export class BinaryReader extends BinaryReaderPrimitive {
	 ...
	 * which adds structured types (vectors, colors, strings, etc.).
	 */
	export class BinaryWriterPrimitive extends BinaryContainer {
	 ...
	 */
	export class BinaryWriter extends BinaryWriterPrimitive {
	 ...
	 */
	export class DebugBinaryWriter extends BinaryWriter {
		constructor() {
			super()
	 ...
	 * r.readVector3F32() // asserts opcode 0x13, then reads the 3 floats
	 */
	export class DebugBinaryReader extends BinaryReader {
		/**
		 * @param {Uint8Array|null} data Optional buffer to read from immediately.
		 */
		constructor(data = null) {
