...
export namespace HarvestMoon
{
	...
	public:
		...
		Set(std::initializer_list<value_t> list)
			: set(list)
		{
		...
		constexpr bool isFront(const citer_t& pos) const { return pos == cbegin(); }
		constexpr bool isEnd(const citer_t& pos) const { return pos == cend(); }
